#!/bin/bash -e
# $File: setup-x.sh
# $Date: Sun Jul 15 11:57:54 2012 +0800
...
eval $(/usr/bin/gpg-agent --sh --no-use-standard-socket \
	--daemon --default-cache-ttl 60 --max-cache-ttl 600)
#keynav &
#xpad &
...
$HOME/script/toggle-touchpad.sh
